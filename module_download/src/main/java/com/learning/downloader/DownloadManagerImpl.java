...
import com.learning.downloader.core.DownloadResponseImpl;
import com.learning.downloader.core.DownloadTaskImpl;
import com.learning.downloader.core.task.DownloadTask;
import com.learning.downloader.db.DefaultDownloadDBController;
...
public final class DownloadManagerImpl implements DownloadManager, DownloadTaskImpl.DownloadTaskListener {
  ...
  public List<DownloadInfo> findAllDownloadFailure() {
    return downloadDBController.findAllDownloadFailure();
  }
